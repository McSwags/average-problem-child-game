...
don't even bother trying to read this piece of shit
or touch anything

trust me it's held together by a lurid blend of Gorilla tape and prayer
*/
...
function bktglitch_init() {
	/*	    
	    This is run automatically, may lag slightly (<0.5s delay)
	*/
	...
	*/
	...
	switch (_preset){
	    case BktGlitchPreset.A:       
	        ...
	        bktglitch_set_noise_level(0.700000);
	        ...
	        bktglitch_set_channel_shift(0.002500);
